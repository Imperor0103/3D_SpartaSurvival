...
public class UIInventory : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        slotPanel = Helper.FindChild(gameObject.transform, "Slots");

        controller = CharacterManager.Instance.Player.controller;
        condition = CharacterManager.Instance.Player.condition;
        dropPosition = CharacterManager.Instance.Player.dropPosition;

        useButton = Helper.FindChild(gameObject.transform, "UseButton").gameObject;
        equipButton = Helper.FindChild(gameObject.transform, "EquipButton").gameObject;
        unEquipButton = Helper.FindChild(gameObject.transform, "UnEquipButton").gameObject;
        dropButton = Helper.FindChild(gameObject.transform, "DropButton").gameObject;

        selectedItemName = Helper.FindChild(gameObject.transform, "ItemName").GetComponent< TextMeshProUGUI>();
        selectedItemDescription = Helper.FindChild(gameObject.transform, "ItemDescription").GetComponent< TextMeshProUGUI>();
